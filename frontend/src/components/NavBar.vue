          ...
          <ul class="navbar-nav d-none d-md-block">
            ...
            <li class="nav-item dropdown" v-if="isAuthenticated">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <router-link to="/tenant" class="dropdown-item dropdown-profile">
                  <font-awesome-icon class="mr-3" icon="user" />Tenant
                </router-link>
                <router-link to="/subject" class="dropdown-item dropdown-profile">
                  <font-awesome-icon class="mr-3" icon="user" />Subject
                </router-link>
